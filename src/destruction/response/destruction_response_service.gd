...
const _DestructionReplacementConsumerScript = preload("res://src/destruction/response/destruction_replacement_consumer.gd")
const _DestructionDebrisConsumerScript = preload("res://src/destruction/response/destruction_debris_consumer.gd")
const _DestructionEffectsConsumerScript = preload("res://src/destruction/response/destruction_effects_consumer.gd")
