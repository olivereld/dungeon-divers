...
@export var floor_color: Color = Color("#1e2024")         # Suelo de habitación oscuro
@export var dungeon_floor_color: Color = Color("#16181b") # Suelo de pasillo oscuro
@export var wall_color: Color = Color("#4a4e54")
@export var column_color: Color = Color("#555a62")
@export var obstacle_color: Color = Color("#3a3e44")
@export var door_color: Color = Color("#3e2c1e")
@export var locked_door_color: Color = Color("#5e1c1e")
@export var stairs_color: Color = Color("#2c3e50")
@export var spawn_color: Color = Color("#1e3c2c")
@export var objective_color: Color = Color("#3c3a1e")
@export var corridor_color: Color = Color("#16181b")      # Suelo de pasillo oscuro
