...
func resolve_stairs_style(context: _StairsPresentationContextScript) -> _ArchitecturalStyleScript.StairsStyle:
	if context == null or context.source_profile == null:
		return _ArchitecturalStyleScript.StairsStyle.STONE
...
func resolve_stairs_specs(
	...
	var style: _ArchitecturalStyleScript.StairsStyle = resolve_stairs_style(context)
