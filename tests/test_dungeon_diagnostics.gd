...
func test_summary_generation() -> void:
	...
	assert(summary.has("avg_edge_spatial_length_mean"), "Summary must have avg_edge_spatial_length_mean")
	assert(summary.has("avg_corridor_short_rate"), "Summary must have avg_corridor_short_rate")
	assert(summary.has("avg_goal_to_centroid_distance"), "Summary must have avg_goal_to_centroid_distance")
	assert(summary.has("avg_boss_to_centroid_distance"), "Summary must have avg_boss_to_centroid_distance")
