...
func test_snapshot_to_dict() -> void:
	...
	assert(dict.has("start_to_centroid_distance"), "Dict must have start_to_centroid_distance")
	...
	assert(dict.has("before_separator_metrics"), "Dict must have before_separator_metrics")
	assert(dict.has("after_separator_metrics"), "Dict must have after_separator_metrics")
	assert(dict.has("dungeon_bounds_area"), "Dict must have dungeon_bounds_area")
...
func test_baseline_save() -> void:
	...
	assert(summary.has("highest_start_to_centroid_distance"), "Summary must have highest_start_to_centroid_distance")
	assert(summary.has("highest_angular_pattern"), "Summary must have highest_angular_pattern")
	assert(summary.has("generation_failures"), "Summary must have generation_failures")
	assert(summary["worst_short_corridors"].has("seed"), "worst_short_corridors must have seed")
	assert(summary["worst_short_corridors"].has("value"), "worst_short_corridors must have value")
	assert(summary["highest_start_to_centroid_distance"].has("seed"), "highest_start_to_centroid_distance must have seed")
	assert(summary["highest_start_to_centroid_distance"].has("value"), "highest_start_to_centroid_distance must have value")
